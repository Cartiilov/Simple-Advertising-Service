            ...
            <form onSubmit={handleSubmit} className={styles.registerRowsContainer}>
                <div className={styles.registerRow}>
                    <label className={styles.label}>
                        Username:
                        <input type="login" value={username} onChange={e => setUsername(e.target.value)} className={styles.input} />
                    </label>
                </div>
                <div className={styles.registerRow}>
                    <label className={styles.label}>
                ...
                <div className={styles.registerRow}>
                    <label className={styles.label}>
                        Repeat Password:
                        <input type="password" value={repeatPassword} onChange={e => setRepeatPassword(e.target.value)} className={styles.input} />
                    </label>
                </div>
                <div className={styles.registerRow}>
                    <Button type="submit" buttonStyle='btn--outline2' onClick={undefined} buttonSize={undefined}>Register</Button>
                </div>
